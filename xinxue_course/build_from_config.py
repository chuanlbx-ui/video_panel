...
心学AI课程推广竖版宣传片（1080×1920），深蓝+金色，4场景。
...
def build_html(config):
    ...
    colors_scheme = cfg.get("colors", {}).get("scheme", "deep_blue_gold")
    colors_opts = cfg.get("colors", {}).get("options", [])
    cs = colors_opts[0] if colors_opts else {"bg_top": "#0a0e27", "bg_bottom": "#0f1a3a",
                                               "white_text": "#fff", "gold_text": "#ffd700",
                                               "cyan_text": "#64b5f6", "subtitle_color": "rgba(100,181,246,0.4)"}
